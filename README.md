...
- Lancer l'appli Preact [`./preact-realworld-example-app`](./preact-realworld-example-app)
- Lancer le nouveau "back-for-front" en Go qui va servir nos super WebComponents
